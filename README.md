...
|[Анализ оттока клиентов банка](https://github.com/xnervousx/Practicum/blob/main/project1/5_games.ipynb)  |Анализ клиентов банка и выделение портрета клиентов, склонных к оттоку, формулировка и проверка гипотез о корреляции параметров, влияющих на отток, разработка рекомендаций по уменьшениб оттока клиентов|python, pandas, matplotlib, seaborn, numpy, scipy|
